...
$pemain=$db->query("select * from pemain where id=".$_GET["id"]);

$data_siswa=$pemain->fetchAll();
    ...
    <div class="row">
        <div class="col">
            ...
            <div class="form-group">
                ...
                <input type="text" name="team" value="<?php echo $data_siswa[0]["team"]; ?>" class="form-control" id="exampleInputPassword1">
            </div>
